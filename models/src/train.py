...
rnn_out1=layers.SimpleRNN(64,return_sequences=True,name='rnn1',recurrent_dropout=0.3)(X)
rnn_out2=layers.SimpleRNN(64,return_sequences=True,name='rnn2',recurrent_dropout=0.3)(rnn_out1)
rnn_out3=layers.SimpleRNN(64,return_sequences=False,name='rnn3')(rnn_out2)
output=layers.Dense(1,activation=None,name='output')(rnn_out3)
